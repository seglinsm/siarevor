      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <div className="space-y-6">
            ...
            <a href="https://maps.google.com/?q=56.5068,21.0109" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 bg-card rounded-lg p-4 hover:bg-secondary/30 transition-colors">
          ...
          <div className="h-80 lg:h-auto rounded-lg overflow-hidden">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2184.5!2d21.0109!3d56.5068!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNTbCsDMwJzI0LjUiTiAyMcKwMDAnMzkuMiJF!5e0!3m2!1sen!2slv!4v1"
              width="100%" height="100%" style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Revor location"
            />
          </div>
        </div>
      </div>
