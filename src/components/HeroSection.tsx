...
export function HeroSection() {
  ...
  const scrollToService = () => {
    document.getElementById("serviss")?.scrollIntoView({
      behavior: "smooth"
    });
  };
      ...
      <div className="relative container mx-auto px-4 py-20">
        <div className="max-w-3xl">
          ...
          animationDelay: "0.3s"
            ...
            <Button size="lg" variant="outline" onClick={scrollToService} className="border-foreground/20 hover:bg-foreground/10">
              Pieteikt remontu
            </Button>
          </div>

          {/* Trust Badges */}
          <div className="flex flex-wrap items-center gap-6 animate-fade-up" style={{
          animationDelay: "0.4s"
        }}>
